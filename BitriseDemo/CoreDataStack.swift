...
open class CoreDataStack {
    ...
    public var managedObjectModel: NSManagedObjectModel = {
        var modelPath = Bundle.main.path(forResource: "BitriseDemo", ofType: "momd")
    ...
    public lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("BitriseDemo.sqlite")
