...
public class CoreDataStack {
    ...
    public var managedObjectModel: NSManagedObjectModel = {
        var modelPath = NSBundle.mainBundle().pathForResource("BitriseDemo", ofType: "momd")
    ...
    public lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("BitriseDemo.sqlite")
